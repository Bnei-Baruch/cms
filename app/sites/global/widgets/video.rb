      ...
      if autoplay == true
        ...
        javascript {
          ...
          $(document).ready(function() {
               ...
               flashembed('flashplayer-#{id}',{wmode: 'opaque', src:'/flowplayer/FlowPlayerLight.swf', bgcolor:'#E5E5E4',width:$player.width(), height:$player.width()/1.33},{config: playerConfig#{id}});
            });
          Embedjs
        }
      else
        div(:id => "flashplayer-#{id}",
          :onclick => "var $player = $('#flashplayer-#{id}');flashembed('flashplayer-#{id}',{wmode: 'opaque', src:'/flowplayer/FlowPlayerLight.swf', bgcolor:'#E5E5E4',width:$player.width(), height:$player.width()/1.33},{config: playerConfig#{id}})") {
