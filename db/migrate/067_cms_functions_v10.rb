class CmsFunctionsV10 < ActiveRecord::Migration
  def self.up
    sql = <<-my_code
    -- ################################################################################
    -- ################################################################################
    ...
    /*
     ...
     - p_placeholders       varchar[]       : array of tree node placeholders to return to

     Valid examples:

       select * from cms_treenode_subtree(17, ARRAY['content_page','website'], true, true, 2, null, 0, 0, true, null)
       select * from cms_treenode_subtree(17, ARRAY['content_page','website'], true, null, 1, null, null, null, null, null)
       select * from cms_treenode_subtree(17, ARRAY['content_page','website'], null, null, 1, null, null, null, false, null)
       select * from cms_treenode_subtree(17, null, null, null, null, null, 3, 20, null, null)
       select * from cms_treenode_subtree(17, null, false, null, 2, null, 1, null, null, null)
       select * from cms_treenode_subtree(17, null, true, null, 1, null, null, null, null, null)
       select * from cms_treenode_subtree(17, ARRAY['content_page','website'], null, false, null, ARRAY['title','sdasf','sub_title',''], 0, 10, null, null)
    ...
    */
    ...
    CREATE OR REPLACE FUNCTION cms_treenode_subtree(
    	...
    	p_return_parent boolean,
            p_placeholders  character varying[]) 
    ...
    BEGIN
      ...
      FOR rw IN SELECT a.*
        FROM
          (select t.* from connectby('tree_nodes', 'id', 'parent_id', 'position',  cast(p_tn_id AS text), COALESCE(p_depth, 0)) AS t(id int, parent_id int, level integer, position int)) t
