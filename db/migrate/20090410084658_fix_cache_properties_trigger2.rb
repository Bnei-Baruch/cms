class FixCachePropertiesTrigger2 < ActiveRecord::Migration
  def self.up
    sql = <<-my_code
    ...
    $BODY$
            ...
            if TG_OP = 'INSERT' then
              ...
              if l_exists > 0 then
                select 
                  CASE WHEN "Type" = 'bool' THEN
    		'boolean'
                  ELSE
    		"Type"
                  END into l_etype 
    	    from cms_util_describe where "Table" = 'cms_cache_resource_properties' and "Field" = l_fname;
