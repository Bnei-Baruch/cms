class AddHideBreadcrumbsToSearch < ActiveRecord::Migration
  def self.up
    migration_login

    resource_type = ResourceType.find(:first, :conditions => {:hrid => 'search'})
    raise 'Failed to find search resource type' unless resource_type
