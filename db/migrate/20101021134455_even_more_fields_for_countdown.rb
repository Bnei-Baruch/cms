class EvenMoreFieldsForCountdown < ActiveRecord::Migration
  def self.up
    migration_login
    ...
    property = Property.new(
      ...
      :is_required => false)
    raise 'Failed to create property \'Countdown-href\'' unless property
    property.save!
  end
  ...
  def self.down
    ...
    property = Property.find(:first, :conditions => {:hrid => 'countdown-href', :resource_type_id => resource_type.id})
    if property
